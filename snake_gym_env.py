...
class SnakeEnv(gym.Env):
    ...
    def reset(self, seed=None, options=None):
        ...
        self.snake = deque([Vector2(5, 10), Vector2(4, 10), Vector2(3, 10)])
        self._randomize_fruit()
        self.done = False
        self.score = 0
        self.previous_action = None
        self.previous_distance = None
        self.step_counter = 0  # 🆕 Track episode length
    ...
    def step(self, action):
        ...
        if self.previous_action is not None:
            ...
            if action == opposite.get(self.previous_action):
        ...
        # ⌛ Time penalty (scales with episode)
        reward -= 0.05 * self.step_counter
        ...
        if self.previous_distance is not None:
            ...
            if delta > 0:
                ...
                reward -= abs(delta) * 0.2

        # 🔁 Optional penalty for same action (slight encouragement to explore)
